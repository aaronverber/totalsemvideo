<div id="sidebar" class="sidebar pjax_links">
	...
	<a href="index.php" class="logo"><span>Total Seminars Video</span></a>
	...
	<div id="search_side" class="dark_box"><form><input class="" type="text" placeholder="Search Videos..."></form></div>
